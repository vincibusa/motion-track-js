  ...
  const onResults = useCallback(
    (results) => {
      ...
      if (allLandmarksExist) {
        ...
        const newAngle = calculateShoulderFlexion(leftHip, leftShoulder, leftElbow);
        setAngle(newAngle);
        ...
        const alignmentAngle = checkPositionAlignment(leftHip, leftShoulder);
...
export default ShoulderFlexionLeft;