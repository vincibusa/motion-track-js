// MotionTrackerRight.jsx
import React, { useRef, useState, useEffect, useCallback } from 'react';
import * as MediapipePose from '@mediapipe/pose';
import { Camera } from '@mediapipe/camera_utils';
import '@mediapipe/pose/pose';
import { FaStopwatch, FaChartLine, FaAngleRight, FaPlay } from "react-icons/fa";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3 text-white">
                ...
                <span className="text-lg font-semibold shadow-sm">
                  Spalla Destra: {Math.round(angle)}°
                </span>
              </div>
            </div>
...
export default MotionTrackerRight;